...
class RangeSlider: UIControl {
  ...
  var trackTintColor = UIColor(white: 0.9, alpha: 1) {
    ...
    var trackHighlightTintColor = UIColor.brandColor(.whitegreen) {
    didSet {
      trackLayer.setNeedsDisplay()
    }
  }
  
    var thumbImage = UIImage(named: AssetIcon.filterControl.rawValue) {
    didSet {
    ...
    var highlightedThumbImage = UIImage(named: AssetIcon.filterControl.rawValue) {
    didSet {
